      ...
      <div className="relative">
        ...
        <div className="relative flex items-center gap-3 px-5 py-3 bg-destructive text-destructive-foreground rounded-2xl shadow-xl backdrop-blur-sm">
          ...
          <div className="flex items-center gap-0.5 ml-1">
            <div className="w-0.5 h-2 bg-destructive-foreground rounded-full animate-pulse" style={{ animationDelay: '0ms' }}></div>
            <div className="w-0.5 h-3 bg-destructive-foreground rounded-full animate-pulse" style={{ animationDelay: '150ms' }}></div>
            <div className="w-0.5 h-4 bg-destructive-foreground rounded-full animate-pulse" style={{ animationDelay: '300ms' }}></div>
            <div className="w-0.5 h-3 bg-destructive-foreground rounded-full animate-pulse" style={{ animationDelay: '450ms' }}></div>
          </div>
        </div>
      </div>
    </div>
